  ...
  <body>
      <div class="container">    
          ...
          <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                      <div class="panel panel-info">
                          <div class="panel-heading">
                              <div class="panel-title">Registrati a <strong>Drive<big>App</big><i class="glyphicon glyphicon-cloud"></i></strong></div>
                          ...
                          <div class="panel-body" >
                              <form id="signupform" class="form-horizontal" role="form">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                          <input id="newuser" type="text" class="form-control" name="newuser" placeholder="Username">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                          <input id="newpassword" type="password" class="form-control" name="newpwd" placeholder="Password">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-offset-3 col-md-9">
                                          <button id="btn-signup" type="submit" class="btn btn-info"> Registrati</button>
